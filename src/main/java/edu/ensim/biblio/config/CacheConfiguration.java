...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(edu.ensim.biblio.domain.Actes.class.getName(), jcacheConfiguration);
            cm.createCache(edu.ensim.biblio.domain.Article.class.getName(), jcacheConfiguration);
            cm.createCache(edu.ensim.biblio.domain.Article.class.getName() + ".auteurs", jcacheConfiguration);
            ...
            cm.createCache(edu.ensim.biblio.domain.Chercheur.class.getName(), jcacheConfiguration);
            cm.createCache(edu.ensim.biblio.domain.Chercheur.class.getName() + ".actes", jcacheConfiguration);
            cm.createCache(edu.ensim.biblio.domain.Chercheur.class.getName() + ".articles", jcacheConfiguration);
            ...
            cm.createCache(edu.ensim.biblio.domain.Note.class.getName(), jcacheConfiguration);
