...
describe('Service Tests', () => {
    ...
    describe('PublicationGouvernementale Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PublicationGouvernementaleService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/publication-gouvernementales';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PublicationGouvernementale', () => {
