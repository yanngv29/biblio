...
import { RapportDialogComponent } from '../../../../../../main/webapp/app/entities/rapport/rapport-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Rapport Management Dialog Component', () => {
        let comp: RapportDialogComponent;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [RapportDialogComponent],
                providers: [
                    RapportService
                ]
            })
            .overrideTemplate(RapportDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'rapportListModification', content: 'OK'});
