...
import edu.ensim.biblio.config.audit.AuditEventConverter;
import edu.ensim.biblio.domain.PersistentAuditEvent;
...
import static edu.ensim.biblio.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
